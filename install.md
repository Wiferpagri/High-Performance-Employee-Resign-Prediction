# High Performance Employee Resign Prediction guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `high_performance_employee_resign_prediction/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `high_performance_employee_resign_prediction` folder and use the modules inside your notebooks :
...
```python
from high_performance_employee_resign_prediction.utils.paths import data_dir
data_dir()
```
